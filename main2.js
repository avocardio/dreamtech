...
function communication() {
	...
	let confirm = hist[hist.length - 1];
    let last = hist[hist.length - 2];
    let second_last = hist[hist.length - 3];
    let third_last = hist[hist.length - 4];
    let fourth_last = hist[hist.length - 5];
	...
	if (confirm == "5") {
		...
		if (last == "2" && second_last == "2" && third_last == "2" && fourth_last == "2") {
			string += "g";
		} else if (last == "2" && second_last == "2" && third_last == "2") {
			string += "f";
		} else if (last == "2" && second_last == "2") {
			string += "e";
		} else if (last == "2") {
			string += "d";
		}
		...
		if (last == "4" && second_last == "4" && third_last == "4" && fourth_last == "4") {
			string += "n";
		} else if (last == "4" && second_last == "4" && third_last == "4") {
			string += "m";
		} else if (last == "4" && second_last == "4") {
			string += "l";
		} else if (last == "4") {
			string += "k";
		}
		...
		if (last == "6" && second_last == "6" && third_last == "6" && fourth_last == "6") {
			string += "r";
		} else if (last == "6" && second_last == "6" && third_last == "6") {
			string += "q";
		} else if (last == "6" && second_last == "6") {
			string += "p";
		} else if (last == "6") {
			string += "o";
		}
		...
		if (last == "7" && second_last == "7" && third_last == "7" && fourth_last == "7") {
			string += "v";
		} else if (last == "7" && second_last == "7" && third_last == "7") {
			string += "u";
		} else if (last == "7" && second_last == "7") {
			string += "t";
		} else if (last == "7") {
			string += "s";
		}
		...
		if (last == "9" && second_last == "9" && third_last == "9" && fourth_last == "9") {
			string += "z";
		} else if (last == "9" && second_last == "9" && third_last == "9") {
			string += "y";
		} else if (last == "9" && second_last == "9") {
			string += "x";
		} else if (last == "9") {
			string += "w";
		}
